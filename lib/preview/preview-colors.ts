...
const trial: PreviewColors = {
  ...
  buttonText: '#7878A0',
  toolbarBg: '#ffffff',
  toolbarBorder: '#E4E4EE',
  toolbarBorderActive: '#007B33',
  searchBg: '#ffffff',
  searchBorder: '#E4E4EE',
  searchText: '#7878A0',
  searchPlaceholder: '#BCBCCE',
  summaryText: '#7878A0',
  summaryStrong: '#111120',
  cardBg: '#FFF9F2',
  cardBorder: '#E4E4EE',
  cardShadow: '0 2px 12px 0 rgba(30, 56, 40, 0.07), 0 1px 3px 0 rgba(30, 56, 40, 0.05)',
  ...
  emptyText: '#7878A0',
  pickerPanelBg: '#ffffff',
  pickerPanelBorder: '#E4E4EE',
  pickerLabel: '#111120',
  previewShellBg: '#F7F7FC',
  previewShellBorder: '#E4E4EE',
  wineInfoBg: '#ffffff',
